...
public class SalasController {
    ...
    @PostMapping("/criar")
    public String criarSalaSubmit(@ModelAttribute("sala") Salas sala,
        ...
        try {
            Salas novaSala = salasService.criarSala(sala.getNomeSala(), sala.getDescricaoSala(),
                    sala.getValorSala(), sala.getQtdeComporta(), sala.getCidade(),
                    sala.getEstado(), sala.getEndereco(), imagem);
            ...
            model.addAttribute("error", "Erro ao processar a imagem.");
            return "criar_sala";
        }
    }
}
